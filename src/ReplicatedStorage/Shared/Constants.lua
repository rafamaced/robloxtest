...
-- ============================================================
-- Aquarium (GDD Section 6, UI Design Section 4)
-- ============================================================
Constants.AQUARIUM = {
    ...
    -- Tank purchase costs (UI Design Section 4.5)
    TANK_PURCHASE_COSTS = {
        { coins = 0,     levelRequired = 1  }, -- Tank 1 (free)
        { coins = 2500,  levelRequired = 1  }, -- Tank 2
        { coins = 10000, levelRequired = 10 }, -- Tank 3
        { coins = 25000, levelRequired = 20 }, -- Tank 4
        { coins = 50000, levelRequired = 35 }, -- Tank 5
    },

    -- Tank upgrade costs (UI Design Section 4.5)
    TANK_UPGRADE_COSTS = {
        { fromSize = "Small",  toSize = "Medium", coins = 5000,  gems = 150 },
        { fromSize = "Medium", toSize = "Large",  coins = 15000, gems = 400 },
        { fromSize = "Large",  toSize = "Giant",  coins = 50000, gems = 1200 },
    },

    -- Biome themes (GDD Section 6.1, task spec)
    BIOMES = {
        { id = "Default",      name = "Default",       costCoins = 0,    costGems = 0,   bgColor = Color3.fromRGB(13, 33, 55) },
        { id = "CoralGarden",  name = "Coral Garden",  costCoins = 2000, costGems = 50,  bgColor = Color3.fromRGB(20, 60, 80) },
        { id = "Volcanic",     name = "Volcanic",      costCoins = 5000, costGems = 100, bgColor = Color3.fromRGB(60, 20, 10) },
        { id = "Abyssal",      name = "Abyssal",       costCoins = 8000, costGems = 150, bgColor = Color3.fromRGB(5, 5, 20) },
        { id = "Prismatic",    name = "Prismatic",     costCoins = 12000,costGems = 250, bgColor = Color3.fromRGB(30, 10, 40) },
    },

    -- Research station upgrades (GDD Section 6.3)
    RESEARCH_UPGRADES = {
        { id = "TankFiltration",   name = "Tank Filtration",   effect = "Creatures in tanks stay visually fresh",          cost = 3000,  levelRequired = 1 },
        { id = "CreatureScanner",  name = "Creature Scanner",  effect = "+5% rare detection range",                        cost = 5000,  levelRequired = 3 },
        { id = "BaitWorkshop",     name = "Bait Workshop",     effect = "Craft better bait from common creatures",          cost = 10000, levelRequired = 5 },
        { id = "TradeTerminal",    name = "Trade Terminal",    effect = "Access marketplace from your aquarium",            cost = 15000, levelRequired = 8 },
        { id = "ExpeditionMap",    name = "Expedition Map",    effect = "See daily hotspot zones with boosted spawns",      cost = 20000, levelRequired = 12 },
        { id = "CreatureLab",      name = "Creature Lab",      effect = "Small chance to breed duplicate eggs from tanks",  cost = 50000, levelRequired = 20 },
    },
}
